...
namespace ProfileBot.Clu
{
    /// <summary>
    /// A helper class that creates and populates <see cref="RecognizerResult"/> from a <see cref="AnalyzeConversationResult"/> instance.
    /// </summary>
    internal static class RecognizerResultBuilder
    {
        ...
        {
            var entities = prediction.GetProperty("entities").GetRawText();
